                ...
                <div class="col-md-9">
                    ...
                    <div class="answer-content mt-4">
                        <div class="post-item my-4 border-bottom">
                            <div class="vote-col">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <div class="votes-count">1</div>
                                    <button title="This post is not useful"
                                    ...
                                    <button title="Mark the answer ans accepted" class="btn p-0 answer-accepted">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-check-lg icon-lg" viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="post-col actionable">
                                <div class="question-body">
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate, tenetur!
                                        Deleniti, dicta qui.
                                        Debitis quidem ad laborum incidunt itaque nostrum, officiis eaque perspiciatis
                                        ratione magni
                        ...
                        <div class="post-item my-4 border-bottom">
                            ...
                            <div class="post-col actionable">
                                <div class="question-body">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga soluta error amet
                                        sed, earum
                                        sapiente, iure, facilis tempore aspernatur quidem odit. Minima nulla numquam ad
                                        voluptate!
                                        Laboriosam quisquam necessitatibus error.</p>
                                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis ea, numquam
                                        excepturi repellat quas
                                        commodi, corporis magnam eveniet hic quaerat alias dolor sint dolores neque
